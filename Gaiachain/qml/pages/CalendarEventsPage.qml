...
CalendarPageBase {
    ...
    ColumnLayout {
        ...
        Layout.margins: 1.5 * s(GStyle.hugeMargin)
        spacing: 1.5 * s(GStyle.smallMargin)
        ...
        Components.EventsListView {
            Layout.topMargin: -parent.spacing + s(GStyle.middleMargin)
            Layout.fillWidth: true
        ...
        Items.GCheckBox {
            ...
            Layout.fillWidth: true
            Layout.bottomMargin: s(GStyle.hugeMargin)
